...
const Modal = (props: PropsWithChildren<{ open: boolean; onClose: () => void }>) => {
  ...
  return (
    ...
    >
      {open ? (
        <section className='relative bg-gradient-to-b from-green-500 via-green-200 to-green-500 p-0.5 rounded-xl'>
          <div className='overflow-y-auto w-screen h-screen sm:min-w-[55vw] sm:max-w-[90vw] sm:min-h-[69vh] sm:max-h-[90vh] sm:w-fit sm:h-fit p-8 sm:rounded-xl bg-zinc-800'>
